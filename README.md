...
- Checkpoint split scoring with calibrated cumulative route targets, grades, collision/offroad penalties, deterministic drift/clean-line style scoring, chain breaks, and bounded telemetry history.
...
- Level tuning pass: add alternate route profiles, harder target tiers, and score-threshold variants.
