...
- Low-poly procedural highway with curves, elevation, road stripes, roadside props, horizon, and a player car placeholder.
- Fixed-step car simulation for acceleration, braking, steering, drift, offroad, and collision hooks.
- HUD/debug panels for speed, distance, checkpoint, collision, top speed, offroad time, lateral position, and lap.
- Unit tests for track generation, car dynamics, and telemetry.
...
- Level design pass: named routes, curve/elevation pacing, checkpoint timing, and roadside composition.
